...
import segundo.GUI.MDIprincipal;
import segundo.GUI.RegistroUsuarios;
import segundo.m.Usuarios;

public class Segundo {
    public static ArrayList<Usuarios> usuarios = new ArrayList<>();
    public static MDIprincipal mdi;
    public static RegistroUsuarios ru; 
